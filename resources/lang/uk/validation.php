...
return [
    ...
    'attributes' => [
        ...
        'temporaryAddress'=>'Адреса тимчасового проживання',
        'adults'=>'Дорослі',
        'childs'=>'Діти',
        'disabledPersons'=>'Інваліди',
        'pregnantPersons'=>'Вагітні',
        'socialNetworks'=>'Соц мережі',
        'dataVerified'=>'Підтвердження достовірності інформації',
        'refugeerRequirements'=>'Потреби'
    ],
];
